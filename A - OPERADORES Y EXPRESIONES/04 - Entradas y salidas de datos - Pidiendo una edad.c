...
{
    int a;				//Primero fijamos las variables con las que vamos a trabajar. Vamos a usar un número entero en este ejemplo, pero podríamos usar un número con decimales o un caracter (float, char...).
    ...
    printf("Tu edad es %i \n",a);	//Lógicamente tenemos que imprimir el resutlado, por lo que volvemos a usar printf e imprimimos el resultado con el input del usuario.
