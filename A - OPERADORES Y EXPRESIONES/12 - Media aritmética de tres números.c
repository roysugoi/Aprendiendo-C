...
int main() 				//Esta es la funci�n principal (main) que vamos a crear. "Int" quiere decir que es un número entero.		
{
	...
	media = (n1 + n2 + n3) / 3;			//De esta manera calculamos la media aritm�tica de 3 números, sumando los 3 y dividi�ndolos entre el número de d�gitos a introducir.
	
	printf("La media es: %f",media);	//Imprimimos el resultado, de un número REAL por lo que usamos %f, y tras la coma especificamos que queremos la soluci�n de la funci�n denominada media.
