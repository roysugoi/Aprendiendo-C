...
int main() 				//Esta es la funci�n principal (main) que vamos a crear. "Int" quiere decir que es un número entero.		
{
	...
	printf("El total de la compra es %.2f �",precio);	//Parte textual del resultado, usamos número REAL, por tanto %.2f (.2 para que nos salgan dos decimales solo) y tras la coma argumentamos que queremos el resultado de la funci�n precio.
